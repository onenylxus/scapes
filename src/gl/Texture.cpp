...
Texture::Texture()
{
	Logger::LogTrace(ModuleData::Name::TEXTURE, "Texture()");
...
{
	Logger::LogTrace(ModuleData::Name::TEXTURE, "void Bind(const unsigned int &index) const");
...
{
	Logger::LogTrace(ModuleData::Name::TEXTURE, "void Create(const Texture::Data &data)");
...
{
	Logger::LogTrace(ModuleData::Name::TEXTURE, "int GetTexture() const");
